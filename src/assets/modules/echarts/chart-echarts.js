...
jQuery(function ($) {
  ...
  CMPLTADMIN_SETTINGS.dashboardEcharts = function () {
    ...
    if ($('#browser_type').length) {
      ...
      var option = {
        ...
        grid: {
          ...
          y2: 20,
          borderWidth: 0,
          backgroundColor: charts_transparent_color,
          borderColor: charts_transparent_color,
        },
        ...
        tooltip: {
          ...
          axisPointer: {
            ...
            lineStyle: { color: charts_tooltip_line_color, width: 1 },
            shadowStyle: { color: charts_tooltip_shadow_color },
          },
        },
        ...
        xAxis: [
          {
            ...
            axisLine: {
              ...
              onZero: true,
              lineStyle: {
                color: charts_icon_color,
                type: 'solid',
                width: '2',
                shadowColor: charts_transparent_color,
                shadowBlur: 5,
                shadowOffsetX: 3,
                shadowOffsetY: 3,
              },
            ...
            splitLine: {
              show: false,
              lineStyle: {
                color: charts_xaxis_split_line_color,
                type: 'solid',
                width: 0,
                shadowColor: charts_transparent_color,
              },
        ...
        yAxis: [
          {
            ...
            splitLine: {
              show: false,
              lineStyle: {
                color: charts_yaxis_split_line_color,
                type: 'solid',
                width: 0,
                shadowColor: charts_transparent_color,
              },
        ...
        series: [
          {
            ...
            itemStyle: {
              normal: {
                ...
                borderWidth: 4,
                borderColor: charts_primary_color,
                areaStyle: { color: charts_primary_color, type: 'default' },
              },
            },
        ...
        series: [
          {
            ...
            itemStyle: {
              normal: {
                ...
                borderWidth: 4,
                borderColor: charts_primary_color,
                areaStyle: { color: charts_series_area_color, type: 'default' },
              },
            },
          ...
          },
          {
            ...
            itemStyle: {
              normal: {
                color: charts_accent_color,
                borderWidth: 2,
                borderColor: charts_accent_color,
                areaStyle: { color: charts_accent_color, type: 'default' },
              },
            },
    ...
    if ($('#platform_type_dates').length) {
      ...
      var option_dt = {
        timeline: {
          ...
          height: 50,
          backgroundColor: charts_transparent_color,
          borderColor: charts_timeline_border_color,
          borderWidth: 0,
          padding: 5,
    ...
    if ($('#scatter_chart').length) {
      ...
      var option = {
        color: [charts_primary_color, charts_accent_color],
        title: {
          // text: '',
          // subtext: ''
        },
        ...
        series: [
          {
            ...
            title: {
              ...
              offsetCenter: [0, '120%'],
              textStyle: {
                color: charts_series_title_color,
                fontSize: 15,
              },
            },
            detail: {
              ...
              backgroundColor: charts_transparent_color,
              borderWidth: 0,
              borderColor: charts_series_border_color,
              width: 100,
              height: 40,
              offsetCenter: [0, '40%'],
              formatter: '{value}%',
    ...
    if ($('#page_views_today_bar').length) {
      ...
      var myChart = echarts.init(
        document.getElementById('page_views_today_bar'),
      )
    ...
    if ($('#scatter_chart_inside').length) {
      // Initialize after dom ready
      var myChart = echarts.init(
        document.getElementById('scatter_chart_inside'),
      )
    ...
    if ($('#platform_type_dates_pie').length) {
      var myChart = echarts.init(
        document.getElementById('platform_type_dates_pie'),
      )
    ...
    if ($('#platform_type_dates_donut').length) {
      var myChart = echarts.init(
        document.getElementById('platform_type_dates_donut'),
      )
    ...
    if ($('#platform_type_dates_funnel').length) {
      var myChart = echarts.init(
        document.getElementById('platform_type_dates_funnel'),
      )
        ...
        series: [
          {
            ...
            pointer: {
              width: 50,
              length: '90%',
              color: charts_series_pointer_color,
            },
            title: {
              show: true,
              offsetCenter: [0, '-60%'],
